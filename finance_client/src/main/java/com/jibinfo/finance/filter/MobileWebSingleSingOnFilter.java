...
public class MobileWebSingleSingOnFilter extends OncePerRequestFilter {
	@Override
	protected void doFilterInternal(HttpServletRequest request,
		...
		if (null == authorization || (null != userIdCookie && !authorization.getId().toString().equals(userIdCookie.getValue()))) {
			...
			String loginUrl = Configuration.getProperty("system", "mobile.web.login.url") + "?fromUrl=" + requestUrl;
	...
	private boolean whiteList(String url){
		String patternStr =  Configuration.getProperty("system", "mobile.web.server.exclude.url.pattern");
		if (null != patternStr) {
