...
public class SurverysDataDTO implements Serializable {
    private Long id;

    private Long parOptionId;

    private String parOptionName;
    ...
    public void setParOptionName(String parOptionName) {
        this.parOptionName = parOptionName;
    }

    public String getParOptionName() {
        return parOptionName;
    }
